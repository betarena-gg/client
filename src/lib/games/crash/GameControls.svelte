...
<script>
  ...
  let xBet = null;
  $: coinImage = "https://nanogames.io/coin/BTC.black.png";
...
<div id="crash-control-1" class="sc-hLVXRe cYiOHZ game-control style1">
  <div
    ...
    <button
      ...
      class={activePanel === 1 ? "is-active" : ""}><div class="label">Manual</div></button>
      <button
      disabled={autoBetting}
      on:click={setActivePanel(2)}
      class={activePanel === 2 ? "is-active" : ""}><div class="label">
            ...
            >
              ...
              <div class="input-control">
                <input
                  ...
                  type="text"
                  value={(parseFloat(currentAmount)).toFixed(7)}
                /><img
                  alt=""
                  class="coin-icon"
                  src={coinImage}
